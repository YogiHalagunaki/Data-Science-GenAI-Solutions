...
This project provides a FastAPI-based Client-server architecture interface for running Small Language Models (SLMs) like Qwen, LLaMA, and Gemma locally. You can download, load, chat with, unload, and delete models using simple REST API endpoints.
