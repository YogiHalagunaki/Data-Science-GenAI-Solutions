...
from utils.config import db_url, llm_model, embedding_model

from dotenv import load_dotenv
load_dotenv()

db_url = db_url  ## ./tmp/lancedb
...
embedder=AzureOpenAIEmbedder(model=embedding_model)

# with open('./home/yogi/Desktop/GenAI_Solutions/OCR_OUTPUT/test_ocr.json', 'r') as file:
#     data = json.load(file)

file_path="./home/yogi/Desktop/Python_Code/assignment-bnp/Genel Energy.pdf"

data=[ocr_output(file_path)]
# logger.info(small)
# data = json.load(data)
# logger.info(data[:10])
